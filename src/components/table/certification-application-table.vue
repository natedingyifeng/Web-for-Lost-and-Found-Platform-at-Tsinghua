...
export default {
  ...
  data: function () {
    return {
      lostList: [
        {id: 1, created_at: "2020.11.1 12:58", created_by: "丁一峰", lost_item: "Airpods Pro", lost_place: "第六教学楼", lost_time: "10月31日晚上八点左右", status: "未通过"},
        {id: 2, created_at: "2020.11.2 21:23", created_by: "苏敬恒", lost_item: "Macbook Pro", lost_place: "清华学堂", lost_time: "11月2日上午十点左右", status: "未通过"}
      ],
      options: [
